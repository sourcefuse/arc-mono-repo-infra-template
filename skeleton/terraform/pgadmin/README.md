...
| <a name="module_pgadmin_applications"></a> [pgadmin\_applications](#module\_pgadmin\_applications) | git@github.com:sourcefuse/terraform-k8s-app.git | 0.1.4 |
...
| [aws_ssm_parameter.pgadmin_password](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
